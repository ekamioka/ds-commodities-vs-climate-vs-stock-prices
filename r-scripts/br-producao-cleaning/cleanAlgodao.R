...
xlsfile = "15_04_13_10_29_32_algodaoseriehist.xls"
sheets = c("Area", "ProdutAlgCar", "ProdutPluma", "ProdutCarAlg", "RendPluma", "ProducAlgCar", "ProducPluma", "ProducCarAlg")
...
## export to csv
write.csv(dt_uf, file = "producao_algodao_uf.csv")
write.csv(dt_regiao, file = "producao_algodao_regiao.csv")
