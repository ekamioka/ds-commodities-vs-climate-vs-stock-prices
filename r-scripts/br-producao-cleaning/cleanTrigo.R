...
xlsfile = "15_04_13_10_31_06_trigoseriehist.xls"
sheets = c("Area", "Produtividade", "Producao")
header = c("UF", "2000", "2001", "2002", "2003", "2004", "2005", "2006", "2007", "2008", "2009", "2010", "2011", "2012", "2013", "2014Prev")
colrange = c(1,26:40)
...
## export to csv
write.csv(dt_uf, file = "producao_trigo_uf.csv")
write.csv(dt_regiao, file = "producao_trigo_regiao.csv")
